...
namespace HugoTorrico.Controllers
{
    public class CustomersController : Controller
    {
        ...
        {
            return View(await _context.Customers.Where(c => c.Active).ToListAsync()); // Filtrar solo los activos
        }
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FirstName,LastName,DocumentNumber")] Customer customer)
        {
            if (ModelState.IsValid)
            {
                ...
                customer.Active = true; // Asegurarse de que el cliente esté activo al crearlo
        ...
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FirstName,LastName,DocumentNumber")] Customer customer)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    customer.Active = true; // Asegurarse de que el cliente permanezca activo después de la edición
                    await _context.SaveChangesAsync();
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (customer != null)
            {
                customer.Active = false; // Marcamos como inactivo
                _context.Update(customer);
                await _context.SaveChangesAsync();
            }
